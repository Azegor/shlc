...
public:
    CleanupScope(llvm::Type *varType, llvm::AllocaInst *alloca, llvm::Function *destructor)
...
public:
    ...
    llvm::Type* getCleanupTargetType() const {
        return cleanupTargetVarType;
    }

    void enterCleanupScope(llvm::Type* varType, llvm::AllocaInst *varAlloca, llvm::Function *destructor) {
        assert(!blockScopeInfos.empty());
