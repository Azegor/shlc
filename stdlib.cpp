/*
 * Copyright 2014 Tilman Priesner <email>
 *
...
void prt_w_i(types::int_t i, types::int_t wdth) { std::printf("%*lld", (int)wdth, i); }
void prtln_i(types::int_t i) { std::printf("%lld\n", i); }

void prt_f(types::flt_t f) { std::printf("%Lf", f); }
void prt_w_f(types::flt_t f, types::int_t wdth) { std::printf("%*Lf", (int)wdth, f); }
